...
export class CommentComponent {
  ...
  deleteComment() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          this.http.delete(`${environment.BASE_URL}/posts/${this.postId}/comments`, {
            headers,
  ...
  updateComment(updatedContent: string) {
    ...
    this.http.put(`${environment.BASE_URL}/posts/${this.postId}/comments`, requestBody, { headers }).subscribe({
      next: (response: any) => {
