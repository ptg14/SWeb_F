...
@Component({
  ...
  standalone: true,
  imports: [CreatepostComponent, PostComponent, ActivefriendsComponent, NgFor, HttpClientModule],
...
export class HomepageComponent implements OnInit {
  ...
  FetchPosts() {
    if (this.user) {
      this.http.get(`${environment.BASE_URL}/posts/home/${this.user?.id}`, { headers }).subscribe((response: any) => {
